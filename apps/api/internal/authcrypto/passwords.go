...
// HashPassword derives an argon2id hash from the password and returns it in the
// encoded PHC string format.
...
// VerifyPassword checks the password against an encoded argon2id hash using a
